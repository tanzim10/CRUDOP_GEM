...
#           key: {
#             "EMPNO" => 1,       # Use an actual integer for a numeric attribute
#             "FirstName" => "Tanzim",
#           },
#           table_name: 'Employee',
#         })
...
#       # def dy_delete_item(table_name, key_hash)

#       #   dynamodb_client.delete_item({
#       #     key: key_hash,   # key_hash is a hash containing the key attributes and their values
#       #     table_name: table_name,
#       #   })
#       # end
